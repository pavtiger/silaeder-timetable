            ...
            if ($.inArray(k, columns) === -1) {
                ...
                if (table_columns[k] !== undefined) {
                    if (grade === "-1" || grade === table_columns[k]) {
                        header.append($('<th style="font-size:18px; background:linear-gradient(0deg, #004643, 10%, #006A4E); color:#FFF9E9" colspan="' + headers_colspan[table_columns[k]] + '"/>').html(table_columns[k]));
                    }
                }
            }
        }
